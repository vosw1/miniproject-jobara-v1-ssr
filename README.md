...
| 이름 | 사진 | 역할 |  
|:--:|:--:|:---------------:|
| 송민경 | <img src="https://avatars.githubusercontent.com/u/153582401?v=4" width="150px"> | 테이블 설계<br/><br/>헤더, 풋터, 글씨체, 로고, 글자 색 등<br/>전체적인 뷰 디자인 통일성 맞추기<br/><br/>개인, 기업) 홈 메인 화면<br/>개인, 기업) 이미지 업로드, 수정<br/><br/>개인, 기업) 커뮤니티 댓글 작성, 수정</br>기업) 채용 공고 작성<br/>개인) 이력서 작성 페이지<br/>개인) 이력서 목록 페이지<br/>개인) 채용공고 찜 목록 페이지<br/>기업) 인재 찜 목록 페이지<br/>기업) 채용 공고 목록 페이지<br/><br/>이미지 관련 단위 테스트|
